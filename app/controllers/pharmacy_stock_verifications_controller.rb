class PharmacyStockVerificationsController < ApplicationController
  ...
  private
    ...
    def pharmacy_stock_verification_params
      params.require(:pharmacy_stock_verification).permit(:id, :reason, :verification_date, :creator, :date_created, :changed_by, :date_changed, :voided, :voided_by, :void_reason, :date_voided, :site_id)
    end
end
