class RelationshipsController < ApplicationController
  ...
  private
    ...
    def relationship_params
      params.require(:relationship).permit(:relationship_id, :person_a, :relationship, :person_b, :creator, :date_created, :voided, :voided_by, :date_voided, :void_reason, :uuid, :site_id)
    end
end
